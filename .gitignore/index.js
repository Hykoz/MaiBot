...
client.login('NjI3MjI0OTU2MDc3NjA0ODY1.XarLgw.8GSP0pllio81Sq30fjB2uN9v5NI')
 
client.on('message', function (message) {
    if (message.content === "?ping") {
        message.channel.sendMessage('Je surveille le serveur ! :ok_hand:')
...
client.on('guildMemberAdd', function (member) {
    ...
    member.guild.channels.get('565096201133752323').send(embed)
    member.addRole('5565147257557614592')
});
...
client.on('guildMemberRemove', function (member) {
    let embed = new Discord.RichEmbed()
        ...
        .setFooter('Nous sommes désormais ' + member.guild.memberCount)
    member.guild.channels.get('5565096201133752323').send(embed)
});
...
client.on('message', function (message) {
    ...
    if (args[0].toLowerCase() === prefix + 'kick') {
       ...
       if (!member.kickable) return message.channel.send("Je ne peux pas exclure cet utilisateur :pensive:")
       member.kick()
...
client.on('message', function (message) {
    ...
    if (args[0].toLocaleLowerCase() === prefix + 'ban') {
       ...
       if (!member.bannable) return message.channel.send("Je ne peux pas bannir cet utilisateur :pensive:")
...
client.on('message', function (message) {
    if(message.content.startsWith("?mp")) {
        ...
        if(!msge) return message.channel.send("Veuillez précisez un message ! :smile:")

        var mpall = new Discord.RichEmbed()
        .setThumbnail(client.user.avatarURL)
        .setTimestamp()
        .setColor("RANDOM")
        .addField("MESSAGE DE OLYMPIA", msge);
        message.delete()
